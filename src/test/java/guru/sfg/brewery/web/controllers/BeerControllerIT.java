...
public class BeerControllerIT extends BaseIT{
    ...
    void initCreationFormWithAdmin() throws Exception {
         mockMvc.perform(get("/beers/new").with(httpBasic("sumantakumar", "sumantakumar")))
                .andExpect(status().isOk())
                .andExpect(view().name("beers/createBeer"))
                .andExpect(model().attributeExists("beer"));
    }
    ...
    void findBeersWithHttpBasic() throws Exception{
        mockMvc.perform(get("/beers/find").with(anonymous()))//.with(httpBasic("sumantakumar","sumantakumar")))
                .andExpect(status().isOk())
                .andExpect(view().name("beers/findBeers"))
                .andExpect(model().attributeExists("beer"));
    }
